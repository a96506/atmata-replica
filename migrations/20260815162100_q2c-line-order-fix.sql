-- Q2C line_order fix: redefine create_* RPCs so remote DBs that already
-- applied M15 get line_order on product-line INSERTs (M14 pattern).
-- customer_receipt allocations unchanged (no line_order column).
